                ...
                <table class="table table-striped table-advance table-hover">
                    ...
                    <tr>
                        <th colspan="3">
                            ...
                            <a href="{{ route('admin.emails.sync') }}" class="btn btn-sm red">
                                <i class="fa fa-refresh"></i> Sync
                            </a>
                            <span style="font-size: 9px;">Last sync: <b>{{ $sync->last_sync->diffForHumans() }}</b></span>
                        </th>
                    ...
                    @foreach($messages as $message)
                        <tr class="unread" data-messageid="{{ $message->message_id }}">
                            ...
                            <td class="view-message hidden-xs">
                                <a href="{{ route('admin.emails.show', $message->message_no) }}">{{ $message->froms[0]->mailbox }}</a>
                            </td>
                            <td class="view-message ">
                                <a href="{{ route('admin.emails.show', $message->message_no) }}">{{ $message->subject }}</a>
                            </td>
